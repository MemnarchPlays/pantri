...
- [ ] Port field in Settings → Interface accepts any valid TCP port (1–65535) and saves it to `.env`
...
## [BUG] BUG-010 — Port values below 1024 are blocked by UI and server-side validation
